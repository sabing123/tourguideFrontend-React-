...
class Popup extends React.Component { 
    ...
    handleChange = (event) =>{
      ...
      handleSubmit = (e) => {
        ...
        alert('Successfully Added Hotel Information');
...
<div className='form-main'>
      <div className='myForm'>
        ...
        <h1 style={{textAlign:'center'}}>Add Hotel Information</h1> 
        </div>
        ...
        <input type="text" className="form-control" name="name" id="name" placeholder="Hotel Name......" 
